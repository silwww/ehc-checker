...
Version 1.7 adds: AFI I.5 consignee pattern confirmed standard (never flag regardless of destination or end customer). AFI Variolac 'DAIRY WHEY POWDER' commodity description accepted at FRCQF1 (low notice only). Full AF-prefix batch numbers on AFI 8322 loads confirmed correct — never flag. Combined seal/trailer photo accepted as full photo evidence — one shot verifies seal number, integrity and trailer plate. Calibration notes E18-E20 added.
