...
The current rule set is **v1.5 — April 2026**, based on the combined rule set and checker brief developed by RR Cunningham for UK dairy EHCs. Credit to the original author; this project adapts the rule set into a structured, queryable format.
