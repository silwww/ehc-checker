...
The current rule set is **v1.8 — April 2026**, based on the combined rule set and checker brief developed by RR Cunningham for UK dairy EHCs. Credit to the original author; this project adapts the rule set into a structured, queryable format.
...
│   │   ├── rule_set.md        # Monolithic rule set (Parts A-F, v1.8)
